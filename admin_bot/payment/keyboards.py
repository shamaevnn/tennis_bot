...
def back_to_payment_groups_when_changing_payment_keyboard(year: Union[str, int], month: Union[str, int]):
    buttons = [[
...
def cancel_confirm_changing_payment_info_keyboard(payment_id: Union[str, int], amount: Union[str, int]):
    buttons = [[
        InlineKeyboardButton(
            text=CONFIRM,
...
def change_payment_info_keyboard(year: Union[str, int], month: Union[str, int], group_id: Union[str, int]):
    buttons = [[
            InlineKeyboardButton(
...
def choose_year_to_group_payment_keyboard(year: Union[str, int], month: Union[str, int]):
    buttons = [
        [
