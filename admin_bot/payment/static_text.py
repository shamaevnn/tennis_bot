...
TARIF = "Тариф"
TO_INSERT_PAYMENT_DATA_HELP_INFO = (
    "Для того, чтобы внести данные об оплате, введи данные в формате \n\n"
...
NO_SUCH_OBJECT_IN_DATABASE = (
    "Нет такого объекта в базе данных — неправильный id\n/cancel"
)
...
MONTH_PAYMENT_INFO = """
{year} — {str_month}
<b>{total_paid_text}: {total_amount_for_month}</b>
<b>{must_pay_text}: {should_pay_this_month}</b>
{choose_group_text}
"""
