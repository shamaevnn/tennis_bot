...
WILL_SAY_THAT_TRAIN_IS_CANCELLED = 'Хорошо, сообщу {last_name} {first_name}, что тренировка  {date_tlg} \n<b>{time_tlg}</b> отменена.'
TRAIN_IS_ALREADY_CANCELLED = 'Тренировка уже отменена.'
WISH_GOOD_TRAIN = 'Хорошо, приятной тренировки!\n' \
                  '📅Дата: <b>{date_tlg} ({day_of_week})</b>\n' \
                  '⏰Время: <b>{time_tlg}</b>\n\n'
