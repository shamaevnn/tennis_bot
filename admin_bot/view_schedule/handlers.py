...
def show_trainingroupday_info(update, context):
    ...
    tr_day: GroupTrainingDay = GroupTrainingDay.objects.select_related(
        'group'
    ).prefetch_related(
        'visitors', 'pay_visitors', 'pay_bonus_visitors'
    ).get(id=tr_day_id)
