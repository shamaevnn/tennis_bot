...
def insert_pay_bonus_visitor_players_from_users(apps, schema_editor):
    ...
    for tr_day in GroupTrainingDay.objects.all().iterator():
        users_tg_ids = list(tr_day.pay_bonus_visitors.all().values_list('id', flat=True))
        players = Player.objects.filter(tg_id__in=users_tg_ids)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='players_absent',
            field=models.ManyToManyField(blank=True, help_text='Кто сегодня отсутствует', to='base.Player', verbose_name='Отсутствующие'),
        ),
        migrations.AddField(
            model_name='grouptrainingday',
            name='players_pay_bonus_visitors',
            field=models.ManyToManyField(blank=True, help_text='Платный отыгрыш', related_name='pay_bonus_visitors', to='base.Player', verbose_name='Заплатили ₽ + отыгрыш'),
        ),
        migrations.AddField(
            model_name='grouptrainingday',
            name='players_pay_visitors',
            field=models.ManyToManyField(blank=True, help_text='Заплатили за занятие', related_name='pay_visitors', to='base.Player', verbose_name='Заплатившие игроки'),
        ),
        migrations.AddField(
            model_name='grouptrainingday',
            name='players_visitors',
            field=models.ManyToManyField(blank=True, help_text='Пришли из других групп\n', related_name='visitors', to='base.Player', verbose_name='Игроки из других групп'),
        ),
