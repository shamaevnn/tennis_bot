...
class CancelLessonCase(TestCase):
    ...
    def test_cancel_lesson_for_visitor(self)-> None:
        ...
        utils.change_tr_day_available_status_and_send_alert(trday,GroupTrainingDay.CANCELLED)
    ...
    def test_not_available_lesson(self)-> None:
        ...
        trday.save();
        visitor_bonus_lessons_before = player.bonus_lesson
        utils.change_tr_day_available_status_and_send_alert(trday,GroupTrainingDay.NOT_AVAILABLE)
    ...
    def test_cancel_lesson_for_pay_visitor(self)-> None:
        ...
        self.assertEqual (pay_visitor.n_cancelled_lessons, pay_visitor_cancelled_lessons_before + 1)
    ...
    def test_cancel_lesson_for_pay_bonus_visitors(self)-> None:
        ...
        self.assertEqual (pay_visitor.n_cancelled_lessons, pay_visitor_n_cancelled_lessons_before)
