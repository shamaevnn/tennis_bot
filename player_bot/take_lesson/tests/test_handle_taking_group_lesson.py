...
class NoFreePlacesTests(TestCase):
    ...
    def setUp(self):
        ...
        self.gr_u_w_bl = CreateData.group_player(tg_id=350490234, first_name='Nikita 1', bonus_lesson=10)
        self.gr_u_wo_bl = CreateData.group_player(tg_id=350490235, first_name='Nikita 2', bonus_lesson=0)
        self.arb_u_w_bl = CreateData.arbitrary_player(tg_id=350490236, first_name='Nikita 3', bonus_lesson=10)
        self.arb_u_wo_bl = CreateData.arbitrary_player(tg_id=350490236, first_name='Nikita 4', bonus_lesson=0)
        ...
        self.gr_4_mp_al = CreateData.group(max_players=4, available_for_additional_lessons=True)
        self.gr_5_mp_al = CreateData.group(max_players=5, available_for_additional_lessons=True)
        self.gr_6_mp_al = CreateData.group(max_players=6, available_for_additional_lessons=True)
