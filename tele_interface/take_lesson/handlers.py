...
from base.utils import bot_edit_message, moscow_datetime, DT_BOT_FORMAT, clear_broadcast_messages, \
    get_time_info_from_tr_day, get_actual_players_without_absent, get_n_free_places
from tele_interface.keyboard_utils import create_calendar
from tele_interface.take_lesson.keyboard_utils import ind_group_type_training_keyboard, \
...
from tele_interface.take_lesson.utils import get_potential_days_for_group_training, handle_taking_group_lesson, \
