...
from tele_interface.manage_data import PAYMENT_MONEY_AND_BONUS_LESSONS
from tele_interface.take_lesson.utils import handle_choosing_type_of_payment_for_pay_visiting_when_have_bonus_lessons
